<?php
	...
	CLASS ISC_SUGGESTIVECARTCONTENT_PANEL extends PANEL
	{
		public function SetPanelSettings()
		{
			...
			$remaining_places = 8-count($prod_ids);
			...
			if(!empty($prod_ids)) {
				...
				$query = "
					...
					WHERE p.productid IN (".$suggest_prod_ids.") AND p.prodvisible='1'
...
$GLOBALS['HideActionAdd'] = '';
                ...
                $GLOBALS['FreteCat'] = FreteTipo($row['productid']);
                $GLOBALS['ProCat'] = simulador_de_rodape($row['productid']);
