...
CLASS ISC_HTMLHEAD_PANEL extends PANEL
{
	public function SetPanelSettings()
	{
		...
		if(isset($GLOBALS['TPL_CFG']['HeaderImageElement'])) {
			...
			$headerImages = array(
				GetConfig('ImageDirectory') . '/header_images/' . GetConfig('template') . '_headerImage.jpg',
				GetConfig('ImageDirectory') . '/header_images/' . GetConfig('template') . '_headerImage.png',
				'templates/'.GetConfig('template') . '/images/' . GetConfig('SiteColor') . '/headerImage.jpg',
				'templates/'.GetConfig('template') . '/images/' . GetConfig('SiteColor') . '/headerImage.png'
			);
		...
		if(!empty($GLOBALS['TPL_CFG']['Stylesheets'])) {
			...
			// Color overrides
			$colorCSS = 'Styles/'.GetConfig('SiteColor').'.css';
			if(file_exists(ISC_BASE_PATH.'/templates/'.GetConfig('template').'/'.$colorCSS)) {
				$stylesheets[] = array(
					'stylesheet' => $colorCSS
				);
			}
			...
			if(file_exists(ISC_BASE_PATH.'/templates/'.GetConfig('template').'/'.$genericIE)) {
				$stylesheets[] = array(
		...
		$GLOBALS['Stylesheets'] = '';
		$styleRoot = GetConfig('ShopPath').'/templates/'.GetConfig('template');
