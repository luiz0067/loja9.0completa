...
class ISC_SITEMAP_MODEL_CATEGORIES extends ISC_SITEMAP_MODEL implements iISC_SITEMAP_MODEL {
	...
	*/
	public function getTree ($limit = null, $offset = null)
	{
		...
		$sql = $set->generateGetTreeSql(array('categoryid', 'catname'), ISC_NESTEDSET_START_ROOT, ISC_NESTEDSET_DEPTH_ALL, $limit, $offset, true, $this->_getRestrictions());
	...
	*/
	public function countAll ()
	{
		...
		$sql = $set->generateGetTreeSql(array('categoryid'), ISC_NESTEDSET_START_ROOT, ISC_NESTEDSET_DEPTH_ALL, null, null, true, $this->_getRestrictions());
