...
class ISC_SITEMAP_MODEL_PAGES extends ISC_SITEMAP_MODEL implements iISC_SITEMAP_MODEL {
	...
	*/
	public function getTree ($limit = null, $offset = null)
	{
		...
		$sql = $set->generateGetTreeSql(array('pageid', 'pagetitle', 'pagetype', 'pagelink'), ISC_NESTEDSET_START_ROOT, ISC_NESTEDSET_DEPTH_ALL, $limit, $offset, true, $this->_getRestrictions());
	...
	*/
	public function countAll ()
	{
		...
		$sql = $set->generateGetTreeSql(array('pageid'), ISC_NESTEDSET_START_ROOT, ISC_NESTEDSET_DEPTH_ALL, null, null, true, $this->_getRestrictions());
	...
	*/
	protected function _getRestrictions ()
	{
		...
		$loggedIn = !!$GLOBALS['ISC_CLASS_CUSTOMER']->GetCustomerId();
