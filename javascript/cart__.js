...
var Cart = {
	...
	EstimateShipping: function()
	{
		...
		$('.EstimateShipping .EstimateShippingButtons input').attr('disabled', true);
		 	...
		 	/*if (d.shippingZoneState.value == "0"){alert("Selecione seu estado."); d.shippingZoneZip1.focus(); return false;  }*/
			if (d.shippingZoneZip1.value == ""){alert("O campo CEP deve ser preenchido!"); d.shippingZoneZip1.focus(); return false;  }
			if (d.shippingZoneZip2.value == ""){alert("O campo CEP deve ser preenchido!"); d.shippingZoneZip2.focus(); return false;  }
	...
	Atendimento: function(itemId)
	{
		$.iModal({
			type: 'ajax',
			url: 'demo/atendimento.html'
		});
	},
