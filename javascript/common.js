/* Common Javascript functions for use throughout Loja Virtual V2010 */
...
function inline_add_to_cart(filename, product_id, quantity, returnTo) {
	...
	var html = '<form action="' + filename + '/compras.php" method="post" id="inlineCartAdd">';
...
function isc_TrackSearchClick (searchId) {
	...
	var trackurl = 'buscas.php?action=tracksearchclick&searchid=' + encodeURIComponent(searchId) + '&random=' + Math.random();
