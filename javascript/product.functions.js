...
function showVideoPopup(videoId) {
	...
	window.open(config.ShopPath + "/imagens.php?video_id="+videoId, "imagePop", "toolbar=0,scrollbars=1,location=0,statusbar=1,menubar=0,resizable=1,width=530,height=430,top="+t+",left="+l);
}
