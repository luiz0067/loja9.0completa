...
class FileClass
{
	...
	public function ReadaFile($file)
	{
		if (!file_exists($file)) {
			return false;
		}
	...
	*/
	...
	public function WriteToFile($str, $filename)
	{
	...
	*/
	...
	public function AppendToFile($str, $filename)
	{
		return $this->__write($str,$filename,'a+');
	}

	public function __write($str,$filename,$mode)
	{
