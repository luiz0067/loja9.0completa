		...
		<td>
			<table class="Panel">
				...
				<tr>
					...
					<td>
						<input type="text" name="brandName" id="brandName" class="Field400" value="%%GLOBAL_BrandName%%">
					</td>
				</tr>
				<tr>
					<td class="FieldLabel">
				...
				<tr>
					...
					<td>
						<input type="text" id="brandSearchKeywords" name="brandSearchKeywords" class="Field400" value="%%GLOBAL_BrandSearchKeywords%%">
