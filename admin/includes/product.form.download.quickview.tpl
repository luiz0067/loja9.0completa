<table>
	<tr>
		...
		<td>
			<input type="text" name="downloads[%%GLOBAL_DownloadId%%][downdescription]" id="DownloadDescription" value="%%GLOBAL_DownloadDescription%%" class="Field200" />
		</td>
	</tr>
	<tr>
		<td class="FieldLabel">
		...
		<td>
			<input type="text" name="downloads[%%GLOBAL_DownloadId%%][downexpiresafter]" id="DownloadExpiresAfter" class="%%GLOBAL_DownloadExpires%%" class="Field40" />
			<select name="downloads[%%GLOBAL_DownloadId%%][downexpiresrange]" id="DownloadExpiresRange">
	...
	<tr>
		...
		<td>
			<input type="text" name="downloads[%%GLOBAL_DownloadId%%][downmaxdownloads]" id="DownloadMaxDownloads" class="Field40" />
