	...
	<div id="design_mode_menu" class="DesignModeMenu">
		...
		<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td><img title="%%LNG_SaveDesignMode%%" src="%%GLOBAL_IMG_PATH%%/IcoDesignModeSave.gif" class="DesignModeButton" onmouseover="this.className='DesignModeButtonOver'" onmouseout="this.className='DesignModeButton'" onclick="document.forms['dm_form'].submit()" /></td>

				<td><img title="%%LNG_CancelDesignMode%%" src="%%GLOBAL_IMG_PATH%%/IcoDesignModeCancel.gif" class="DesignModeButton" onmouseover="this.className='DesignModeButtonOver'" onmouseout="this.className='DesignModeButton'" onclick="design_mode_cancel()" /></td>

				<td><img title="%%LNG_UpdateDesignMode%%" src="%%GLOBAL_IMG_PATH%%/IcoDesignModeUpdate.gif" class="DesignModeButton" onmouseover="this.className='DesignModeButtonOver'" onmouseout="this.className='DesignModeButton'" onclick="design_mode_update()" /></td>
