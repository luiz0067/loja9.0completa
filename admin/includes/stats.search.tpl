	...
	<tr>
		<td class="Heading1">Relatorios de Buscas</td>
	</tr>
	<tr>
		<td class="Intro">
	...
	<tr>
		<td class="Intro">
			<div>
				<input type="button" name="clearSearchStats" value="Limpar Relatorios" onclick="clearStatsClick()" class="SmallButton" />
			</div>
		</td>
	</tr>
	<tr>
			...
			<div style="padding:5px 0px 5px 10px" class="Text FloatLeft">
				<table border=0 cellspacing=0 cellpadding=0>
					<tr>
						...
						<td style="background: #eee;">Faixa de Data:</td>
						<td style="background: #eee; padding: 3px 5px;" width="1">
