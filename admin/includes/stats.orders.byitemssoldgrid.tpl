...
<div style="text-align:right; display: %%GLOBAL_HideStatsRows%%">
...
<table width="100%" border=0 cellspacing=1 cellpadding=5 class="text">
	<tr class="Heading3">
		...
		<td align="left">
			<span onmouseover="ShowQuickHelp(this, '%%LNG_Orders%%', '%%LNG_OrdersByItemsSoldOrderHelp%%');" onmouseout="HideQuickHelp(this);" class="HelpText">%%LNG_Orders%%</span> &nbsp;
