		...
		<td class="Intro">
			...
			<tr>
				<td class="Intro" valign="top">
					<input type="button" name="IndexAddButton" value="%%LNG_AddProductVariation%%..." id="IndexCreateButton" class="SmallButton" onclick="document.location.href='index.php?ToDo=addProductVariation'" style="width:160px" /> &nbsp;
					...
					<input type="button" name="IndexImportButton" value="%%LNG_ImportProductVariations%%" id="IndexImportButton" class="SmallButton" onclick="window.location='index.php?ToDo=importProductVariations';" %%GLOBAL_DisableImport%% />
				</td>
			</tr>
			</table>
		</td>
