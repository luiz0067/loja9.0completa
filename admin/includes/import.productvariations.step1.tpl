	...
	<div class="BodyContainer">
		...
		<tr>
			<td class="Heading1">%%LNG_ImportProductVariationsStep1%%</td>
		</tr>
		<tr>
			<td class="Intro">
				<p>%%LNG_ImportProductVariationsStep1Desc%%</p>
				%%GLOBAL_Message%%
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td>
			  <table class="Panel">
				...
				<tr>
					<td class="FieldLabel">
						<span class="Required">&nbsp;</span>&nbsp;%%LNG_UpdateExistingVariations%%
					</td>
					<td>
						<label><input type="checkbox" name="UpdateExisting" value="1" checked="checked"/> %%LNG_YesUpdateExistingVariations%%</label>
						<img onmouseout="HideHelp('a2');" onmouseover="ShowHelp('a2', '%%LNG_UpdateExistingVariations%%', '%%LNG_UpdateExistingVariationsHelp%%')" src="images/help.gif" width="24" height="16" border="0">
						<div style="display:none" id="a2"></div>
					</td>
				</tr>
				<tr>
					<td class="FieldLabel">
						<span class="Required">&nbsp;</span>&nbsp;%%LNG_DefaultForEmptyValues%%
					</td>
					<td>
						<label><input type="checkbox" name="DefaultForEmpty" value="1" /> %%LNG_YesDefaultForEmptyValues%%</label>
						<img onmouseout="HideHelp('a4');" onmouseover="ShowHelp('a4', '%%LNG_DefaultForEmptyValues%%', '%%LNG_DefaultForEmptyValuesHelp%%')" src="images/help.gif" width="24" height="16" border="0">
						<div style="display:none" id="a4"></div>
					</td>
				</tr>
				<tr>
					<td class="FieldLabel">
						<span class="Required">&nbsp;</span>&nbsp;%%LNG_CreateAllCombinations%%
					</td>
					<td>
						<label><input type="checkbox" name="CreateAllCombos" value="1" /> %%LNG_YesCreateAllCombinations%%</label>
						<img onmouseout="HideHelp('a5');" onmouseover="ShowHelp('a5', '%%LNG_CreateAllCombinations%%', '%%LNG_CreateAllCombinationsHelp%%')" src="images/help.gif" width="24" height="16" border="0">
			  ...
			  <table class="Panel">
				...
				<tr>
					...
					<td>
						<label><input type="checkbox" name="Headers" value="1" checked="checked"/> %%LNG_YesImportContainsHeaders%%</label>
