	<div class="BodyContainer">
		...
		<tr>
			<td class="Heading1">%%LNG_ImportProductVariationsStep3%%</td>
		</tr>
		<tr>
			<td class="Intro">
				<p>%%LNG_ImportProductVariationsStep3Desc%%
				</p>
			</td>
		</tr>
		<tr>
	...
	<script type="text/javascript">
		...
		{
			tb_show('', 'index.php?ToDo=importProductVariations&Step=ImportFrame&ImportSession=%%GLOBAL_ImportSession%%&keepThis=true&TB_iframe=tue&height=240&width=400&modal=true', '');
