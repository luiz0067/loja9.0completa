<script type="text/javascript" src="script/page.js?%%GLOBAL_JSCacheToken%%"></script>
			...
			<div id="div_details" style="padding-top: 10px;">
			  ...
			  <table class="Panel">
				...
				<tr class="HideIfLink">
					...
					<td>
						<input type="text" id="pagemetatitle" name="pagemetatitle" class="Field400" value="%%GLOBAL_PageMetaTitle%%">
						<img onmouseout="HideHelp('help_metatitle');" onmouseover="ShowHelp('help_metatitle', '%%LNG_MetaTitle%%', '%%LNG_MetaTitleHelp%%')" src="images/help.gif" width="24" height="16" border="0">
				...
				<tr class="HideIfLink">
					...
					<td>
						<input type="text" id="pagesearchkeywords" name="pagesearchkeywords" class="Field400" value="%%GLOBAL_PageSearchKeywords%%">
				...
				<tr class="HideIfLinkVendor" style="%%GLOBAL_HideVendorSelect%%">
					<td class="FieldLabel">
			 ...
			 <div id="div_optimizer" style="padding-top: 10px; display:none;">
				...
				<table width="100%" class="Panel" style="%%GLOBAL_ShowEnableGoogleWebsiteOptimzer%%">
					...
					<tr>
						...
						<td>
							<input %%GLOBAL_DisableOptimizerCheckbox%% type="checkbox" name="pageEnableOptimizer" id="pageEnableOptimizer" %%GLOBAL_CheckEnableOptimizer%% onclick = "ToggleOptimizerConfigForm(%%GLOBAL_SkipOpimizerConfirmMsg%%);" />
							<label for="pageEnableOptimizer">%%LNG_YesEnableGoogleWebsiteOptimizer%%</label>
						</td>
					</tr>
				</table>
