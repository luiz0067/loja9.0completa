	...
	<tr id="tr%%GLOBAL_MessageId%%" class="GridRow" onmouseover="this.className='GridRowOver'" onmouseout="this.className='GridRow'">
		...
		<td>
			...
			<a title="%%LNG_EditMessage%%" href="%%GLOBAL_ShopPath%%/admin/index.php?ToDo=editOrderMessage&amp;orderId=%%GLOBAL_OrderId%%&amp;messageId=%%GLOBAL_MessageId%%">%%LNG_Edit%%</a>&nbsp;&nbsp;&nbsp;

			<a title="%%LNG_FlagMessage%%" href="%%GLOBAL_ShopPath%%/admin/index.php?ToDo=flagOrderMessage&amp;flagState=%%GLOBAL_FlagState%%&amp;orderId=%%GLOBAL_OrderId%%&amp;messageId=%%GLOBAL_MessageId%%">%%GLOBAL_FlagText%%</a>
