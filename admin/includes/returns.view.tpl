	...
	<table class="OuterPanel">
	  <tr>
		<td class="Heading1" id="tdHeading">%%LNG_CreateNewReturnsView%%</td>
		</tr>
		<tr>
		<td class="Intro">
			<p>%%LNG_ReturnViewIntro%%</p>
			%%GLOBAL_Message%%
			  ...
			  <table class="Panel">
				...
				<tr>
					...
					<td>
						...
						<img onmouseout="HideHelp('d2');" onmouseover="ShowHelp('d2', '%%LNG_NameThisView%%', '%%LNG_NameThisReturnsViewHelp%%')" src="images/help.gif" width="24" height="16" border="0">
				...
				<tr>
					...
					<td>
						<select name="dateRange" id="dateRange" onchange="ToggleRange()" class="Field250">
							<option value="">%%LNG_ChooseReturnDate%%</option>
	...
	<script type="text/javascript">
		...
		function CheckViewForm() {
			...
			if($('#returnFrom').val() != "" && isNaN($('#returnFrom').val())) {
				alert("%%LNG_SearchEnterValidReturnId%%");
				$('#returnFrom').focus();
				$('#returnFrom').select();
				return false;
			}
