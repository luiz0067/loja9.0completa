	...
	<table id="Table13" cellSpacing="0" cellPadding="0" width="100%">
		...
		<td style="display: %%GLOBAL_DisplayGrid%%">
			<form name="frmDiscounts" id="frmDiscounts" method="post" action="index.php?ToDo=deleteDiscounts">
				...
				<div id="SeeMoreDiscountBox" style="display: %%GLOBAL_HideSeeMoreDiscountBox%%">
					<a href="#" onclick="seeMoreDiscountItems(); return false;">%%GLOBAL_DiscountShowNextBatchItems%%</a>
				</div>
			</form>
		</td></tr>
	</table>
