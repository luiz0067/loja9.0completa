		...
		<td>
			<table class="GridPanel SortableGrid AutoExpand" cellspacing="0" cellpadding="0" border="0" id="IndexGrid" style="width:100%;">
				...
				<tr class="GridRow">
					...
					<td><a href="#" onclick="ExpandAllCategories(); return false;">%%LNG_ExpandAllCategories%%</a> / <a href="#" onclick="CollapseAllCategories(); return false;">%%LNG_CollapseAllCategories%%</a></td>
