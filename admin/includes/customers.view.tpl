	...
	<table class="OuterPanel">
	  <tr>
		<td class="Heading1" id="tdHeading">%%LNG_CreateNewCustomersView%%</td>
		</tr>
		<tr>
		<td class="Intro">
			<p>%%LNG_CustomerViewIntro%%</p>
			%%GLOBAL_Message%%
			  ...
			  <table class="Panel">
				...
				<tr>
					...
					<td>
						...
						<img onmouseout="HideHelp('d2');" onmouseover="ShowHelp('d2', '%%LNG_NameThisView%%', '%%LNG_NameThisCustomersViewHelp%%')" src="images/help.gif" width="24" height="16" border="0">
