	...
	<tr id="tr%%GLOBAL_OrderId%%" class="GridRow" onmouseover="this.className='GridRowOver'" onmouseout="this.className='GridRow'">
		...
		<td id="order_status_column_%%GLOBAL_OrderId%%" style="border-left-style: solid; border-left-width: 10px; width:150px;" class="%%GLOBAL_SortedFieldStatusClass%% OrderStatus OrderStatus%%GLOBAL_OrderStatusId%%" nowrap="nowrap">
