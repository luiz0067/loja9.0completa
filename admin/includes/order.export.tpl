			  ...
			  <table class="Panel">
				...
				<tr>
					...
					<td>
						...
						<img onmouseout="HideHelp('d1');" onmouseover="ShowHelp('d1', '%%LNG_ExportFields%%', '%%LNG_ExportFieldsHelp%%')" src="images/help.gif" width="24" height="16" border="0">
				...
				<tr>
					...
					<td>
						...
						&nbsp;<img onmouseout="HideHelp('d2');" onmouseover="ShowHelp('d2', '%%LNG_DateRange%%', '%%LNG_DateRangeOrderHelp%%')" src="images/help.gif" width="24" height="16" border="0">
