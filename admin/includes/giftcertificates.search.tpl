	...
	<table class="OuterPanel">
	  <tr>
		<td class="Heading1" id="tdHeading">%%LNG_SearchGiftCertificates%%</td>
		</tr>
		<tr>
		<td class="Intro">
			<p>%%LNG_SearchGiftCertificatesIntro%%</p>
			%%GLOBAL_Message%%
			...
			<td>
			  <table class="Panel">
				...
				<tr>
					...
					<td>
						%%LNG_SearchFrom%% &nbsp;%%GLOBAL_CurrencyToken%%&nbsp;<input type="text" id="amountFrom" name="amountFrom" class="Field50"> %%LNG_SearchTo%%
						&nbsp;%%GLOBAL_CurrencyToken%%&nbsp;<input type="text" id="amountTo" name="amountTo" class="Field50">
					</td>
				</tr>
				<tr>
					<td class="FieldLabel">
					...
					<td>
						%%LNG_SearchFrom%% &nbsp;%%GLOBAL_CurrencyToken%%&nbsp;<input type="text" id="balanceFrom" name="balanceFrom" class="Field50"> %%LNG_SearchTo%%
						&nbsp;%%GLOBAL_CurrencyToken%%&nbsp;<input type="text" id="balanceTo" name="balanceTo" class="Field50">
					</td>
				</tr>
				<tr><td class="Gap" colspan="2"></td></tr>
			 </table>
