			...
			<div id="dateBlock" style="padding:5px 0px 5px 10px" class="Text FloatLeft">
				<table border=0 cellspacing=0 cellpadding=0>
					<tr>
						...
						<td style="background: #eee;" class="dateField">Faixa de Data:</td>
						<td style="background: #eee; padding: 3px 5px;" width="1" class="dateField">
						...
						<td class="VendorSelect" style="background: #eee; padding: 3px 5px; %%GLOBAL_HideVendorList%%" width="1">
						...
						<td>
							<div id="ShowHideVariationsButtonContainer">
								<input id="ShowHideVariationsButton" type="button" class="Text" onclick="ChangeProductsByInventoryVariations();return false;" value="%%LNG_HideVariations%%" />
							</div>
						</td>
					</tr>
				</table>
	...
	<script type="text/javascript">
		...
		function ChangeProductsByInventoryVariations () {
			...
			var buttonText = '%%LNG_ShowVariations%%';
			if (productsByInventoryVariations) {
				buttonText = '%%LNG_HideVariations%%';
			}
		...
		function LoadProductsByInventoryGrid() {
			...
			jQuery.ajax({url: 'index.php?ToDo=prodStatsByInventoryGrid&vendorId=%%GLOBAL_VendorId%%&Variations='+productsByInventoryVariations+'&Page='+productsByInventoryCurrentPage+'&Show='+productsPerPage+'&SortBy='+productsByInventorySortField+'&SortOrder='+productsByInventorySortOrder,
					 success: function(data) {
