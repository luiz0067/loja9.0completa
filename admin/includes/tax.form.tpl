	...
	<table class="OuterPanel">
		...
		<tr>
			<td class="Intro">
				...
				<input type="submit" value="%%GLOBAL_SaveAndContinue%%" name="addAnother" />
					  ...
					  <table class="Panel">
						...
						<tr>
							...
							<td>
								...
								<div class="NodeJoin">
									<img src="images/nodejoin.gif" alt="" /> <label><input type="checkbox" id="taxshippingfortaxableorder" name="taxshippingfortaxableorder" value="1" %%GLOBAL_TaxShippingForTaxableOrder%% />%%LNG_TaxShippingForTaxableOrder%%</label>
									<img onmouseout="HideHelp('d7');" onmouseover="ShowHelp('d7', '%%LNG_TaxShipping%%', '%%LNG_TaxShippingForTaxableOrderHelp%%')" src="images/help.gif" width="24" height="16"border="0">
