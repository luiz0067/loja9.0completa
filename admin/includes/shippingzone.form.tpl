	...
	<table class="OuterPanel">
		...
		<tr>
			<td class="Intro">
				...
				%%GLOBAL_Message%%
				<p class="TopButtons">
					<input type="submit" name="SubmitButton1" value="%%GLOBAL_NextButton%%" class="FormButton NextButton" />&nbsp;
				...
				<div id="div0">
					...
					<table width="100%" class="Panel">
						...
						<tr>
							...
							<td>
								<input type="submit" name="SubmitButton1" value="%%GLOBAL_NextButton%%" class="FormButton NextButton" />&nbsp;
								<input type="button" name="CancelButton1" value="%%LNG_Cancel%%" class="FormButton CancelButton" onclick="ConfirmCancel()" />
							</td>
						</tr>
					</table>
				</div>
