		...
		<table>
		  ...
		  <tr>
			<td style="padding:10px 0px 5px 0px">
				<strong>%%LNG_Oops%%</strong>
				<p>%%LNG_UpgradeSomethingWrong%%</p>
				<textarea class="Field400" style="width: 100%" rows="10" cols="20" onfocus="this.select();">%%GLOBAL_ErrorMessage%%</textarea>
			</td>
		  </tr>
		</table>
		</td></tr></table>
