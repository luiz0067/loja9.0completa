	...
	<tr>
		<td>
			<ul id="tabnav">
				<li><a href="#" class="active" id="tab0" onclick="ShowTab(0)">%%LNG_WebsiteSettingsTab%%</a></li>
				<li><a href="#" id="tab1" onclick="ShowTab(1)">%%LNG_LocalizationSettingsTab%%</a></li>
				<li><a href="#" id="tab8" onclick="ShowTab(8)">%%LNG_ImageSettings%%</a></li>
				<li><a href="#" id="tab2" onclick="ShowTab(2)">%%LNG_DisplaySettingsTab%%</a></li>
				<li style="display: %%GLOBAL_HideBackupSettings%%"><a href="#" id="tab3" onclick="ShowTab(3)">%%LNG_BackupSettingsTab%%</a></li>
				<li><a href="#" id="tab4" onclick="ShowTab(4)">%%LNG_SearchSettingsTab%%</a></li>
				<li><a href="#" id="tab5" onclick="ShowTab(5)" style="%%GLOBAL_HideLoggingSettingsTab%%" >%%LNG_LoggingSettingsTab%%</a></li>
				<li><a href="#" id="tab6" onclick="ShowTab(6)" style="%%GLOBAL_HideVendorOptions%%">%%LNG_VendorSettingsTab%%</a></li>
				<li><a href="#" id="tab7" onclick="ShowTab(7)">%%LNG_MiscellaneousSettingsTab%%</a></li>
			</ul>
		</td>
	</tr>
	<tr>
		<td>
			<div id="div0" style="padding-top: 10px;">
				...
				<tr>
					...
					<td>
						<label for="NoSSL"><input type="radio" name="UseSSL" id="NoSSL" value="0" %%GLOBAL_NoSSLChecked%% /> %%LNG_DontUseSSL%%</label>
						...
						<br />
						<label for="UseNormalSSL"><input type="radio" name="UseSSL" id="UseNormalSSL" value="1" %%GLOBAL_UseNormalSSLChecked%% /> %%LNG_UseInstalledSSL%%</label>
						<img onmouseout="HideHelp('sslhelp');" onmouseover="ShowHelp('sslhelp', '%%LNG_SSL%%', '%%LNG_UseInstalledSSLHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
						<div style="display:none" id="sslhelp"></div>
						<br />
						<label for="UseSharedSSL"><input type="radio" name="UseSSL" id="UseSharedSSL" value="2" %%GLOBAL_UseSharedSSLChecked%% /> %%LNG_UseSharedSSL%%</label>
						<img onmouseout="HideHelp('sharedsslhelp');" onmouseover="ShowHelp('sharedsslhelp', '%%LNG_SharedSSL%%', '%%LNG_UseSharedSSLHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
						<div style="display:none" id="sharedsslhelp"></div>
						<div class="NodeJoin">
							<img src="images/nodejoin.gif" alt="" /> <input type="text" class="Field250" id="SharedSSLPath" name="SharedSSLPath" value="%%GLOBAL_SharedSSLPath%%" />
						</div>
						<br />
						<label for="UseSubdomainSSL"><input type="radio" name="UseSSL" id="UseSubdomainSSL" value="3" %%GLOBAL_UseSubdomainSSLChecked%% /> %%LNG_UseSubdomainSSL%%</label>
						<img onmouseout="HideHelp('subdomainsslhelp');" onmouseover="ShowHelp('subdomainsslhelp', '%%LNG_SubdomainSSL%%', '%%LNG_UseSubdomainSSLHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
						<div style="display:none" id="subdomainsslhelp"></div>
						<div class="NodeJoin">
							<img src="images/nodejoin.gif" alt="" /> <input type="text" class="Field250" id="SubdomainSSLPath" name="SubdomainSSLPath" value="%%GLOBAL_SubdomainSSLPath%%"/>
						</div>

						<br />
						<div style='display:inline; padding-left:20px'><font size=1><a href='javascript:void(0)' onclick='TestSSL()' style='color:gray'>Como saber se meu site suporta SSL?</a></font></div>
				...
				<tr>
					<td class="FieldLabel">
						&nbsp;&nbsp; <label for="StoreName">%%LNG_UseControlPanelSSL%%?</label>
					</td>
					<td>
						<input type="checkbox" name="ForceControlPanelSSL" id="UseControlPanelSSL" value="ON" %%GLOBAL_IsControlPanelSSLEnabled%% /> <label for="UseControlPanelSSL">%%LNG_YesUseControlPanelSSL%%</label>
						<img onmouseout="HideHelp('dadminssl');" onmouseover="ShowHelp('dadminssl', '%%LNG_UseControlPanelSSL%%', '%%LNG_JS_UseControlPanelSSLHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
				...
				<tr>
					...
					<td>
						<select id="CharacterSet" name="CharacterSet" class="Field250">
							<option value="UTF-8" %%GLOBAL_CharacterSet_Selected_utf8%%>%%LNG_SettingsCharset_utf8%%</option>
							<option value="ISO-8859-1" %%GLOBAL_CharacterSet_Selected_iso88591%%>%%LNG_SettingsCharset_iso88591%%</option>
							<option value="ISO-8859-15" %%GLOBAL_CharacterSet_Selected_iso885915%%>%%LNG_SettingsCharset_iso885915%%</option>
							<option value="cp866" %%GLOBAL_CharacterSet_Selected_cp866%%>%%LNG_SettingsCharset_cp866%%</option>
							<option value="cp1251" %%GLOBAL_CharacterSet_Selected_cp1251%%>%%LNG_SettingsCharset_cp1251%%</option>
							<option value="cp1252" %%GLOBAL_CharacterSet_Selected_cp1252%%>%%LNG_SettingsCharset_cp1252%%</option>
							<option value="KOI8-R" %%GLOBAL_CharacterSet_Selected_koi8r%%>%%LNG_SettingsCharset_koi8r%%</option>
							<option value="Shift_JIS" %%GLOBAL_CharacterSet_Selected_shiftjis%%>%%LNG_SettingsCharset_shiftjis%%</option>
							<option value="EUC-JP" %%GLOBAL_CharacterSet_Selected_eucjp%%>%%LNG_SettingsCharset_eucjp%%</option>
						</select>
				...
				<tr>
					<td colspan="2" class="EmptyRow">sss
				...
				<tr style="%%GLOBAL_HideLicenseKey%%">
					<td class="FieldLabel">
						<span class="Required">*</span> <label for="serverStamp">%%LNG_LicenseKey%%:</label>
					</td>
					<td>
			...
			<div id="div1" style="padding-top: 10px;">
				...
				<tr>
					<td class="FieldLabel">
						<span class="Required">*</span> <label for="StoreTimezone">%%LNG_StoreTimeZone%%:</label><a name="StoreTimezone" />
					</td>
					<td>
			...
			<input type="hidden" name="AutoResizeImages" id="AutoResizeImages" value="no" />
				<table width="100%" class="Panel">
					<tr>
						<td class="Heading2" colspan="2">%%LNG_ProductThumbnailSizes%%</td>
					</tr>
					<tr>
						<td class="FieldLabel">
							<span class="Required">*</span> %%LNG_StorewideThumbnail%%:
						</td>
						<td>
							<input type="text" name="ProductImagesStorewideThumbnail_width" id="ProductImagesStorewideThumbnail_width" value="%%GLOBAL_ProductImagesStorewideThumbnail_width%%" class="Field40 SetOriginalImageSizeValue" />&nbsp;x&nbsp;&nbsp;<input type="text" name="ProductImagesStorewideThumbnail_height" id="ProductImagesStorewideThumbnail_height" value="%%GLOBAL_ProductImagesStorewideThumbnail_height%%" class="Field40 SetOriginalImageSizeValue" />
							<img onmouseout="HideHelp('productimage_storewidethumbnail');" onmouseover="ShowHelp('productimage_storewidethumbnail', '%%LNG_StorewideThumbnail%%', '%%LNG_StorewideThumbnailHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
					...
					<tr>
						<td class="FieldLabel">
							<span class="Required">*</span> %%LNG_ProductPageImage%%:
						</td>
						<td>
							<input type="text" name="ProductImagesProductPageImage_width" id="ProductImagesProductPageImage_width" value="%%GLOBAL_ProductImagesProductPageImage_width%%" class="Field40 SetOriginalImageSizeValue" />&nbsp;x&nbsp;&nbsp;<input type="text" name="ProductImagesProductPageImage_height" id="ProductImagesProductPageImage_height" value="%%GLOBAL_ProductImagesProductPageImage_height%%" class="Field40 SetOriginalImageSizeValue" />
							<img onmouseout="HideHelp('productimage_productpageimage');" onmouseover="ShowHelp('productimage_productpageimage', '%%LNG_ProductPageImage%%', '%%LNG_ProductPageImageHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
					...
					<tr>
						<td class="FieldLabel">
							<span class="Required">*</span> %%LNG_ProductPageGalleryThumbnail%%:
						</td>
						<td>
							<input type="text" name="ProductImagesGalleryThumbnail_width" id="ProductImagesGalleryThumbnail_width" value="%%GLOBAL_ProductImagesGalleryThumbnail_width%%" class="Field40 SetOriginalImageSizeValue" />&nbsp;x&nbsp;&nbsp;<input type="text" name="ProductImagesGalleryThumbnail_height" id="ProductImagesGalleryThumbnail_height" value="%%GLOBAL_ProductImagesGalleryThumbnail_height%%" class="Field40 SetOriginalImageSizeValue" />
							<img onmouseout="HideHelp('productimage_productpagegallerythumbnail');" onmouseover="ShowHelp('productimage_productpagegallerythumbnail', '%%LNG_ProductPageGalleryThumbnail%%', '%%LNG_ProductPageGalleryThumbnailHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
					...
					<tr>
						<td class="FieldLabel">
							<span class="Required">*</span> %%LNG_ProductPageZoomImage%%:
						</td>
						<td>
							<input type="text" name="ProductImagesZoomImage_width" id="ProductImagesZoomImage_width" value="%%GLOBAL_ProductImagesZoomImage_width%%" class="Field40 SetOriginalImageSizeValue" />&nbsp;x&nbsp;&nbsp;<input type="text" name="ProductImagesZoomImage_height" id="ProductImagesZoomImage_height" value="%%GLOBAL_ProductImagesZoomImage_height%%" class="Field40 SetOriginalImageSizeValue" />
							<img onmouseout="HideHelp('productimage_zoomimage');" onmouseover="ShowHelp('productimage_zoomimage', '%%LNG_ProductPageZoomImage%%', '%%LNG_ProductPageZoomImageHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
					...
					<tr>
						...
						<td>
						<a href="#" id="ReprocessImages">%%LNG_ReprocessImagesLink%%</a>
							<img onmouseout="HideHelp('productimage_reprocessimages');" onmouseover="ShowHelp('productimage_reprocessimages', '%%LNG_ReprocessImages%%', '%%LNG_ReprocessImagesHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
					...
					<tr>
						<td class="FieldLabel">
							&nbsp;&nbsp; %%LNG_ShowTinyThumbnails%%
						</td>
						<td>
						<input type="checkbox" name="ProductImagesTinyThumbnailsEnabled" id="ProductImagesTinyThumbnailsEnabled" value="ON" %%GLOBAL_IsProductImagesTinyThumbnailsEnabled%% /> <label for="ProductImagesTinyThumbnailsEnabled">%%LNG_YesShowTinyThumbnails%%</label>
							<img onmouseout="HideHelp('productimage_tinythumbnailsenabled');" onmouseover="ShowHelp('productimage_tinythumbnailsenabled', '%%LNG_ShowTinyThumbnails%%', '%%LNG_ShowTinyThumbnailsHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
					...
					<tr>
						...
						<td>
						<input type="checkbox" name="ProductImagesImageZoomEnabled" id="ProductImagesImageZoomEnabled" value="ON" %%GLOBAL_IsProductImagesImageZoomEnabled%% /> <label for="ProductImagesImageZoomEnabled">%%LNG_YesEnableImageZoom%%</label>
							<img onmouseout="HideHelp('productimage_enableimagezoom');" onmouseover="ShowHelp('productimage_enableimagezoom', '%%LNG_EnableImageZoom%%', '%%LNG_EnableImageZoomHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
...
<tr>
					...
					<tr>
						<td class="FieldLabel">
							<span class="Required">*</span> Imagem Padrao:
						</td>
						<td class="PanelBottom">
			...
			<div id="div2" style="padding-top: 10px;">
				...
				<table width="100%" class="Panel">
					...
					<tr>
						<td class="FieldLabel">
							&nbsp;&nbsp; <label for="ShowAddThisLink">%%LNG_ShowAddThisLink%%?</label>
						</td>
						<td class="PanelBottom">
							<input type="checkbox" name="ShowAddThisLink" id="ShowAddThisLink" value="1" %%GLOBAL_IsAddThisLinkShown%% /> <label for="ShowAddThisLink">%%LNG_YesShowAddThisLink%%</label>
							<img onmouseout="HideHelp('daddthis');" onmouseover="ShowHelp('daddthis', '%%LNG_ShowAddThisLink%%', '%%LNG_ShowAddThisLinkHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
			...
			<div id="div4" style="padding-top: 10px;">
				<table width="100%" class="Panel">
					<tr>
						<td class="Heading2" colspan="2">%%LNG_SearchSettings%%</td>
					</tr>

					<tr>
						<td class="FieldLabel">
							&nbsp;&nbsp; <label for="SearchOptimisation">%%LNG_SearchOptimisation%%:</label>
						</td>
						<td>
							<select name="SearchOptimisation" id="SearchOptimisation" class="Field200">
								%%GLOBAL_SearchOptimisationOptions%%
							</select>
							<img onmouseout="HideHelp('search8');" onmouseover="ShowHelp('search8', '%%LNG_SearchOptimisation%%', '%%LNG_SearchOptimisationHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
							<div style="display:none" id="search8"></div>
						</td>
					</tr>
					<tr>
						<td class="FieldLabel">
							&nbsp;&nbsp; <label for="SearchDefaultProductSort">%%LNG_SearchDefaultProductSort%%:</label>
						</td>
						<td>
							<select name="SearchDefaultProductSort" id="SearchDefaultProductSort" class="Field200">
								%%GLOBAL_SearchDefaultProductSortOptions%%
							</select>
							<img onmouseout="HideHelp('search1');" onmouseover="ShowHelp('search1', '%%LNG_SearchDefaultProductSort%%', '%%LNG_SearchDefaultProductSortHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
							<div style="display:none" id="search1"></div>
						</td>
					</tr>
					<tr>
						<td class="FieldLabel">
							&nbsp;&nbsp; <label for="SearchDefaultContentSort">%%LNG_SearchDefaultContentSort%%:</label>
						</td>
						<td>
							<select name="SearchDefaultContentSort" id="SearchDefaultContentSort" class="Field200">
								%%GLOBAL_SearchDefaultContentSortOptions%%
							</select>
							<img onmouseout="HideHelp('search2');" onmouseover="ShowHelp('search2', '%%LNG_SearchDefaultContentSort%%', '%%LNG_SearchDefaultContentSortHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
							<div style="display:none" id="search2"></div>
						</td>
					</tr>
					<tr>
						<td class="FieldLabel">
							&nbsp;&nbsp; <label for="SearchProductDisplayMode">%%LNG_SearchProductDisplayMode%%:</label>
						</td>
						<td>
							<select name="SearchProductDisplayMode" id="SearchProductDisplayMode" class="Field200">
								%%GLOBAL_SearchProductDisplayModeOptions%%
							</select>
							<img onmouseout="HideHelp('search6');" onmouseover="ShowHelp('search6', '%%LNG_SearchProductDisplayMode%%', '%%LNG_SearchProductDisplayModeHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
							<div style="display:none" id="search6"></div>
						</td>
					</tr>
					<tr>
						<td class="FieldLabel">
							&nbsp;&nbsp; <label for="SearchResultsPerPage">%%LNG_SearchResultsPerPage%%:</label>
						</td>
						<td>
							<input type="text" name="SearchResultsPerPage" id="SearchResultsPerPage" value="%%GLOBAL_SearchResultsPerPage%%" class="Field40" />
							<img onmouseout="HideHelp('search7');" onmouseover="ShowHelp('search7', '%%LNG_SearchResultsPerPage%%', '%%LNG_SearchResultsPerPageHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
			...
			<div id="div5" style="padding-top: 10px; %%GLOBAL_HideLoggingSettingsTab%%">
				<table width="100%" class="Panel">
					<tr>
					...
					<tr class="SystemLoggingToggle">
						...
						<td style="padding-left: 28px">
							<select name="SystemLogTypes[]" id="SystemLogTypes" multiple="multiple" size="10" class="Field250 ISSelectReplacement">
								...
								<option value="accounting" %%GLOBAL_IsAccountingLoggingEnabled%%>%%LNG_ActionsToLogAccounting%%</option>
							</select>
						</td>
					</tr>
					<tr class="SystemLoggingToggle">
			...
			<div id="div7" style="padding-top: 10px;">
				...
				<table width="100%" class="Panel" style="%%GLOBAL_HideProxyFields%%">
					...
					<tr>
						<td class="FieldLabel">
							<span class="Required">&nbsp;</span> <label for="HTTPProxyServer">%%LNG_HTTPProxyServer%%:</label>
						</td>
						<td>
					...
					<tr>
						<td class="FieldLabel">
							<span class="Required">&nbsp;</span> <label for="HTTPProxyPort">%%LNG_HTTPProxyPort%%:</label>
						</td>
						<td>
					...
					<tr>
						<td class="FieldLabel">
							<span class="Required">&nbsp;</span> <label for="HTTPSSLVerifyPeer">%%LNG_HTTPSSLVerifyPeer%%:</label>
						</td>
						<td>
				...
				<table width="100%" class="Panel">
					<tr>
						<td class="Heading2" colspan="2">%%LNG_AbandonOrderLifetimeHeading%%</td>
					</tr>
					<tr>
						<td class="FieldLabel">
							<span class="Required">&nbsp;</span> <label for="AbandonOrderLifetime">%%LNG_AbandonOrderLifetime%%:</label>
						</td>
						<td>
							<select name="AbandonOrderLifetime" id="AbandonOrderLifetime">
								%%GLOBAL_AbandonOrderLifetimeOptions%%
							</select>
							<img onmouseout="HideHelp('hAbandonOrder');" onmouseover="ShowHelp('hAbandonOrder', '%%LNG_AbandonOrderLifetime%%', '%%LNG_AbandonOrderLifetimeHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
...
<script type="text/javascript" src="script/product.images.reprocess.js?%%GLOBAL_JSCacheToken%%"></script>
<script type="text/javascript">

	ProcessProductImages.lang['ModalTitle'] = '%%LNG_ProcessImagesModalTitle%%';
	ProcessProductImages.lang['ProcessProgress'] = '%%LNG_ProcessImagesProgress%%';
	ProcessProductImages.lang['ProcessFinished'] = '%%LNG_ProcessImagesFinished%%';

	lang['ProductImagesStorewideThumbnailWidthInvalidValue']	= '%%LNG_ProductImagesStorewideThumbnailWidthInvalidValue%%';
	lang['ProductImagesStorewideThumbnailHeightInvalidValue'] = '%%LNG_ProductImagesStorewideThumbnailHeightInvalidValue%%';
	lang['ProductImagesProductPageImageWidthInvalidValue']	= '%%LNG_ProductImagesProductPageImageWidthInvalidValue%%';
	lang['ProductImagesProductPageImageHeightInvalidValue']	= '%%LNG_ProductImagesProductPageImageHeightInvalidValue%%';
	lang['ProductImagesGalleryThumbnailWidthInvalidValue']	= '%%LNG_ProductImagesGalleryThumbnailWidthInvalidValue%%';
	lang['ProductImagesGalleryThumbnailHeightInvalidValue']	= '%%LNG_ProductImagesGalleryThumbnailHeightInvalidValue%%';
	lang['ProductImagesZoomImageWidthInvalidValue']	= '%%LNG_ProductImagesZoomImageWidthInvalidValue%%';
	lang['ProductImagesZoomImageHeightInvalidValue']	= '%%LNG_ProductImagesZoomImageHeightInvalidValue%%';
	...
	$('#frmSettings').submit(function() {
		...
		if(!$("#NoSSL").is(':checked') && $('#UseControlPanelSSL').is(':checked')) {
			if(!checkSSLWorks()) {
				if(!confirm('%%LNG_JS_SSLNotWorking%%')) {
					ShowTab(0);
					return false;
				}
			}
		...
		if('%%GLOBAL_CharacterSet%%' != $('#CharacterSet').val()) {
			var confirmMsg = '%%LNG_JS_ConfirmChangeCharacterSet%%';

			if('%%GLOBAL_CharacterSet%%' == 'UTF-8') {
				confirmMsg = '%%LNG_JS_ConfirmChangeCharacterSetUTF8%%';
			}
		...
		$('.SetOriginalImageSizeValue').each(function() {
			if(isNaN($(this).val()) || $(this).val() == '') {
				...
				if($(this).val().indexOf('%') != -1 || $(this).val().indexOf('px') != -1) {
					alertMsg += '%%LNG_EnterNumberForImageSizesMeasurements%%';
				}
		...
		if(imageSizeChanges){
			if(confirm('%%LNG_ShouldImagesBeResized%%')) {
		...
		if(!$("#SearchResultsPerPage").val() || isNaN($("#SearchResultsPerPage").val())) {
			ShowTab(4);
			alert("%%LNG_EnterSearchResultsPerPage%%");
