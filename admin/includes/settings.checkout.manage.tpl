	...
	<form action="index.php?ToDo=saveUpdatedCheckoutSettings" name="frmCheckoutSettings" id="frmCheckoutSettings" method="post" onsubmit="return ValidateForm(CheckCheckoutSettingsForm)">
		...
		<tr>
			<td class="Intro">
				...
				<p class="TopButtons">
					<input type="submit" value="%%LNG_Save%%" class="FormButton SaveButton" />
					<input type="reset" value="%%LNG_Cancel%%" class="FormButton CancelButton" onclick="ConfirmCancel()" />
				</p>
			</td>
		</tr>
		<tr>
				...
				<div id="div0" style="padding-top: 10px;">
					<table width="100%" class="Panel">
						...
						<tr>
							...
							<td>
								<div id="BuiltInGatewayOption" style="%%GLOBAL_HideBuiltInGateway%%">
									<div>
										<label><input type="radio" id="CheckoutMethodBuiltIn" name="builtInGateway" value="1" %%GLOBAL_UseBuiltInGatewayChecked%% /> %%GLOBAL_UseBuiltInGateway%%</label>
									</div>
									<div class="builtInGateway builtInGateway_1">
										<img src="images/nodejoin.gif" alt="" class="FloatLeft" />
										<div class="BuiltInGatewayForm">
											%%GLOBAL_BuiltInGatewayErrors%%
											<div class="BuiltInCheckoutIntro">
												%%GLOBAL_BuiltInGatewayIntro%%
											</div>
											%%GLOBAL_BuiltInGatewayProperties%%
										</div>
									</div>

									<div>
										<label><input type="radio" id="CheckoutMethodCustom" name="builtInGateway" value="0" %%GLOBAL_UseCustomGatewayChecked%% /> %%LNG_UseCustomGateway%%</label>
									</div>
									<img src="images/nodejoin.gif" alt="" class="FloatLeft builtInGateway builtInGateway_0" />
								</div>
								<div class="builtInGateway builtInGateway_0">
									<select size="20" multiple="multiple" name="checkoutproviders[]" id="checkoutproviders" class="Field300 ISSelectReplacement %%GLOBAL_CheckoutProviderClass%%">
	...
	<script type="text/javascript">
		...
		function CheckCheckoutSettingsForm()
		{
			if($('input[name=builtInGateway]:checked').val() == 1 && $('.BuiltInGatewayForm .MessageBoxError').length > 0) {
				alert('%%LNG_CannotEnableBuiltInModuleErrors%%');
				return false;
			}
