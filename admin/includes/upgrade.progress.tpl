<table id="OuterPanel" cellSpacing="0" cellPadding="0" width="95%">
	<tr>
		<td class="Heading1">
			%%LNG_UpgradeInProgress%%
		</td>
	</tr>
	<tr>
		<td class="Intro">
			<div>%%GLOBAL_UpgradeIntro%%</div>
		</td>
	</tr>
	<tr>
		<td class="Intro">
...
<script type="text/javascript">
	...
	UpdateProgress('%%GLOBAL_RunningStepOfX%%', '%%GLOBAL_PercentComplete%%');
</script>
<!-- iframe which does all of the work -->
<iframe src="index.php?ToDo=runUpgrade&random=%%GLOBAL_Random%%" width="1" height="1" frameborder="0" border="0"></iframe>