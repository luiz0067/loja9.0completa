	...
	<tr>
		<td valign="top" width="33%" class="QuickViewPanel">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td class="text">%%LNG_ShipmentOrderId%%</td>
					<td class="text"><a href="index.php?ToDo=viewOrders&amp;orderId=%%GLOBAL_OrderId%%" target="_blank">#%%GLOBAL_OrderId%%</a>
				<tr>
					<td class="text" valign="top">%%LNG_ShipmentOrderDate%%:</td>
		...
		<td valign="top" width="33%" class="QuickViewPanel" style="padding-left:15px">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="text">%%GLOBAL_ShipmentDate%%</td>
				</tr>
				<tr>
					<td class="text" valign="top">%%LNG_TrackingNumber%%:</td>
					<td class="text">%%GLOBAL_TrackingNo%%</td>
				</tr>
			</table>
		</td>
		<td valign="top" width="33%" style="padding-left:10px">
			<h5>%%LNG_ShippedItems%%</h5>
			%%GLOBAL_ProductsTable%%
			<div style="%%GLOBAL_HideShipmentComments%%">
				<h5 style="margin-top: 10px;">%%LNG_ShipmentComments%%</h5>
				<div style="margin-left: 20px;">
					%%GLOBAL_ShipmentComments%%
				</div>
			</div>
		</td>
	</tr>
