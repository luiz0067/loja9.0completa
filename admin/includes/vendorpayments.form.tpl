								...
								<td>
									<table cellpadding="5">
										...
										<tr id="IssuedCreditField">
											<td style="text-align: right;">%%LNG_IssuedStoreCredit%%:</td>
...
<script type="text/javascript" src="../javascript/jquery/plugins/autocomplete/jquery.autocomplete.js?%%GLOBAL_JSCacheToken%%"></script>
