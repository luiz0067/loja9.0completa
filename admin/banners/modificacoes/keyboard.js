var VKI_attach, VKI_close;
  function VKI_buildKeyboardInputs() {
    ...
    this.VKI_kt = "Portuguese Br";  // Default keyboard layout
    this.VKI_clearPasswords = false;  // Clear password fields on focus
    this.VKI_imageURI = "modificacoes/keyboard.png";
    ...
    this.VKI_attachKeyboard = VKI_attach = function(elem) {
      ...
      var keybut = document.createElement('img');
          ...
          keybut.alt = "Teclado Virtual Loja Virtual";
          keybut.className = "keyboardInputInitiator";
          keybut.title = "Mostrar Teclado Virtual da Loja";
          keybut.elem = elem;
