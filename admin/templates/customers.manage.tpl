		...
		<td class="Intro">
			...
			<td class="SmallSearch" align="right">
				...
				<tr>
					...
					<td nowrap>
						<input name="searchQuery" id="searchQuery" type="text" value="%%GLOBAL_EscapedQuery%%" id="SearchQuery" class="Button" size="20" />&nbsp;
	...
	<script type="text/javascript" src="script/order.js?%%GLOBAL_JSCacheToken%%"></script>
	<script type="text/javascript">
...
<script type="text/javascript" src="script/customers.js?%%GLOBAL_JSCacheToken%%"></script>
