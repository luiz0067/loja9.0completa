<table id="OuterPanel" cellSpacing="0" cellPadding="0" width="95%">
	<tr>
		<td class="Heading1">
			%%LNG_BackupInProgress%%
		</td>
	</tr>
	<tr>
		<td class="Intro">
			<p>%%LNG_BackupInProgressIntro%%</p>
		</td>
	</tr>
	<tr>
		<td class="Intro">
			...
			<div style="text-align: center;"><input type="button" value="%%LNG_CancelBackup%%" class="SmallButton" onclick="CancelBackup()" /></div>
		</td>
	</tr>
</table>
<script type="text/javascript">
	...
	function CancelBackup()
	{
		if(confirm('%%LNG_ConfirmCancelBackup%%'))
		{
			...
			self.parent.location = 'index.php?ToDo=cancelBackup&file=%%GLOBAL_BackupFile%%';
		}
	}
</script>