<table id="OuterPanel" cellSpacing="0" cellPadding="0" width="95%">
	<tr>
		<td class="Heading1">
			%%LNG_QuickBooksShowSyncPopupHeading%%
		</td>
	</tr>
	<tr>
...
<script type="text/javascript"><!--
	...
	lang.QuickBooksShowSyncPopupSuccess = "%%LNG_QuickBooksShowSyncPopupSuccess%%";
	lang.QuickBooksShowSyncPopupSectionFailed = "%%LNG_QuickBooksShowSyncPopupSectionFailed%%";
	lang.QuickBooksShowSyncPopupFailed = "%%LNG_QuickBooksShowSyncPopupFailed%%";
	lang.QuickBooksShowSyncPopupSection = "%%LNG_QuickBooksShowSyncPopupSection%%";
	...
	$(document).ready(
		function()
		{
			AccountingImport.Init(%%GLOBAL_ImportCategories%%, '%%GLOBAL_ModuleID%%');
		}
	);
