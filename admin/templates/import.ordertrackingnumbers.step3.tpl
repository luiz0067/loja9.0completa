	<div class="BodyContainer">
		...
		<tr>
			<td class="Heading1">%%LNG_ImportOrdertrackingnumbersStep3%%</td>
		</tr>
		<tr>
			<td class="Intro">
				<p>%%LNG_ImportOrdertrackingnumbersStep3Desc%%
				</p>
			</td>
		</tr>
		<tr>
	...
	<script type="text/javascript">
		...
		{
			tb_show('', 'index.php?ToDo=importOrdertrackingnumbers&Step=ImportFrame&ImportSession=%%GLOBAL_ImportSession%%&keepThis=true&TB_iframe=tue&height=240&width=400&modal=true', '');
